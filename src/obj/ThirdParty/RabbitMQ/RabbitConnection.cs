...
namespace Followme.AspNet.Core.FastCommon.ThirdParty.RibbitMQ
{
    public class RabbitConnection
    {
        ...
        private readonly Action<RabbitConnection, object, BasicDeliverEventArgs> _receiveAction;
        ...
        public RabbitConnection(string receiveQueue, string receiveExchange,string routingKey, RabbitServerSetting setting, Action<RabbitConnection, object, BasicDeliverEventArgs> receiveAction)
        {
        ...
        public void Start(bool isAutoConnect=true)
        {
            ...
            {
                _logger.Error("The rabbit mq service cannot connect!");
                if (isAutoConnect)
                {
